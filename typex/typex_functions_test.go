	...
	cases := []Case{
		...
		},
		{
			...
			&CaseAssertion{
				...
				String:        "github.com/xoctopus/x/typex/testdata.Contains[[]int,int]",
				Kind:          reflect.Func,
				Implements:    []bool{false, false, true, false, false, false},
				AssignableTo:  []bool{false, false, true, false, false, false},
				ConvertibleTo: []bool{false, false, true, false, false, false},
		...
		},
		{
			...
			&CaseAssertion{
				PkgPath:       "github.com/xoctopus/x/typex/testdata",
				Name:          "ContainsFunc[[]int,int]",
				String:        "github.com/xoctopus/x/typex/testdata.ContainsFunc[[]int,int]",
				Kind:          reflect.Func,
				Implements:    []bool{false, false, true, false, false, false},
				AssignableTo:  []bool{false, false, true, false, false, false},
				ConvertibleTo: []bool{false, false, true, false, false, false},
